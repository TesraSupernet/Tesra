...
var (
	...
	// API Name
	ATTRIBUTE_GETUSAGE_NAME = "Tesra.Attribute.GetUsage"
	ATTRIBUTE_GETDATA_NAME  = "Tesra.Attribute.GetData"
	...
	HEADER_GETVERSION_NAME       = "Tesra.Header.GetVersion"
	HEADER_GETPREVHASH_NAME      = "System.Header.GetPrevHash"
	HEADER_GETTIMESTAMP_NAME     = "System.Header.GetTimestamp"
	HEADER_GETCONSENSUSDATA_NAME = "Tesra.Header.GetConsensusData"
	HEADER_GETNEXTCONSENSUS_NAME = "Tesra.Header.GetNextConsensus"
	HEADER_GETMERKLEROOT_NAME    = "Tesra.Header.GetMerkleRoot"

	TRANSACTION_GETHASH_NAME       = "System.Transaction.GetHash"
	TRANSACTION_GETTYPE_NAME       = "Tesra.Transaction.GetType"
	TRANSACTION_GETATTRIBUTES_NAME = "Tesra.Transaction.GetAttributes"

	CONTRACT_CREATE_NAME            = "Tesra.Contract.Create"
	CONTRACT_MIGRATE_NAME           = "Tesra.Contract.Migrate"
	CONTRACT_GETSTORAGECONTEXT_NAME = "System.Contract.GetStorageContext"
	CONTRACT_DESTROY_NAME           = "System.Contract.Destroy"
	CONTRACT_GETSCRIPT_NAME         = "Tesra.Contract.GetScript"
	...
	RUNTIME_BASE58TOADDRESS_NAME     = "Tesra.Runtime.Base58ToAddress"
	RUNTIME_ADDRESSTOBASE58_NAME     = "Tesra.Runtime.AddressToBase58"
	RUNTIME_GETCURRENTBLOCKHASH_NAME = "Tesra.Runtime.GetCurrentBlockHash"
	RUNTIME_VERIFYMUTISIG_NAME       = "Tesra.Runtime.VerifyMutiSig"

	NATIVE_INVOKE_NAME = "Tesra.Native.Invoke"
	WASM_INVOKE_NAME   = "Tesra.Wasm.InvokeWasm"
